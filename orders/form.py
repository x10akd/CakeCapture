...
class OrderForm(forms.ModelForm):
    ...
    order_address = forms.CharField(widget=forms.TextInput(attrs={'class': 'border-2 border-gray-300 rounded-md p-2'}))
    ...
    recipient_address = forms.CharField(widget=forms.TextInput(attrs={'class': 'border-2 border-gray-300 rounded-md p-2'}))
    recipient_email = forms.EmailField(widget=forms.EmailInput(attrs={'class': 'border-2 border-gray-300 rounded-md p-2', 'required': 'required'}))
    ...
    class Meta:
        ...
        fields = [
            ...
            'order_cell_phone', 'order_address', 'order_email',
            'recipient_name', 'recipient_cell_phone', 'recipient_address',
