    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('ECPay', '綠界支付'), ('line_pay', 'LINE Pay')], default='ECPay', max_length=20)),
                ('store_name', models.CharField(blank=True, max_length=100)),
                ('store_address', models.CharField(blank=True, default='10046 台北市中正區衡陽路 7 號 5 樓', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('unpaid', 'Unpaid'), ('payment_fail', 'Payment Fail'), ('waiting_for_shipment', 'Waiting for shipment'), ('transporting', 'Transporting'), ('completed', 'Completed'), ('cancelled', 'Cancelled'), ('waiting_for_check', 'Waiting for check')], default='waiting_for_check', max_length=100)),
