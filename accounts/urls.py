...
urlpatterns = [
    ...
    path("password-reset-confirm/<uidb64>/<token>/", NewPasswordResetConfirmView.as_view(), name="password-reset-confirm",),
    path("password-reset-complete/", NewPasswordResetCompleteView.as_view(),name="password-reset-complete",),
]
